...
class Add(Tk):
    def __init__(self):
        ...
        Label(self, text='Détails de Category:',bg='gray',fg='black',font=('Courier new', 20, 'bold')).place(x=150, y=70)
        Label(self, text='').pack()
        Label(self, text='Nom:',bg='gray',fg='black', font=('Courier new', 10, 'bold')).place(x=60, y=180)
