...
class Search(Tk):
    def __init__(self):
        ...
        l1=Label(self,text="Rechercher un Client",bg='#e5e5e5', font=("Courier new",20,'bold')).place(x=290,y=40)
        l = Label(self, text="Rechercher par",bg='#e5e5e5', font=("Courier new", 15, 'bold')).place(x=180, y=100)
        n = StringVar()
        p = StringVar()
        a = StringVar()
        e = StringVar()
        ...
        self.listTree = ttk.Treeview(self, height=13,columns=('Nom de Client', 'Numéro de téléphone', 'Adresse', 'Email','Id'))
        self.vsb = ttk.Scrollbar(self,orient="vertical",command=self.listTree.yview)
        self.listTree.configure(yscrollcommand=self.vsb.set)
        self.listTree.heading("#0", text='Client ID', anchor='w')
        self.listTree.column("#0", width=100, anchor='w')
        self.listTree.heading("Nom de Client", text='Nom de Client')
        self.listTree.column("Nom de Client", width=200, anchor='center')
        self.listTree.heading("Numéro de téléphone", text='Numéro de téléphone')
        self.listTree.column("Numéro de téléphone", width=200, anchor='center')
        self.listTree.heading("Adresse", text='Address')
        self.listTree.column("Adresse", width=200, anchor='center')
        ...
        Label(self, text='Detail de client', bg='#e5e5e5', fg='white', font=('Courier new', 20, 'bold')).place(x=70,y=490)
        Label(self, text='Nom de Client:', bg='#e5e5e5', font=('Courier new', 10, 'bold')).place(x=70, y=532)
        Entry(self, textvariable=n, width=30).place(x=200, y=534)
        Label(self, text='Numéro de téléphone:', bg='#e5e5e5', font=('Courier new', 10, 'bold')).place(x=70, y=580)
        Entry(self, textvariable=p, width=30).place(x=200, y=582)
        Label(self, text='Adresse:', bg='#e5e5e5', font=('Courier new', 10, 'bold')).place(x=70, y=630)
