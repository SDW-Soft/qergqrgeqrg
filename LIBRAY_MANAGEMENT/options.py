        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='Bienvenue sur la bibliothèque',fg='black',bg="#e5e5e5" ,font=('Courier new', 30, 'bold'))
                    self.label3.place(x=350, y=22)
                    self.label4 = Label(self, text="ENTRER CLIENT",bg="#e5e5e5", font=('Courier new', 18, 'bold'))
                    ...
                    self.label5 = Label(self, text="ENTRER L'ID DU LIVRE",bg="#e5e5e5", font=('Courier new', 18, 'bold'))
                    ...
                    self.label6 = Label(self, text="INFORMATIONS DÉTAILS",bg="#e5e5e5",  font=('Courier new', 15, 'underline', 'bold'))
                    self.label6.place(x=560, y=300)
                    self.button = Button(self, text='Rechercher un Client', bg="#fca311", width=25, font=('Courier new', 10), command=sest).place(x=240,y=250)
                    self.button = Button(self, text='Rechercher un Livre', bg="#fca311", width=25, font=('Courier new', 10), command=sea).place(x=520,y=250)
                    self.brt = Button(self, text="émettre livre", bg="#fca311", width=15, font=('Courier new', 10), command=ib).place(x=800, y=250)
